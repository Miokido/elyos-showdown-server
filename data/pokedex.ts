export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	bellsprout: {
		...
		abilities: { 0: "Chlorophyll", H: "Gluttony", S: "Ripen" },
		heightm: 0.7,
		weightkg: 4,
		color: "Green",
		evos: ["Weepinbell"],
	...
	omastar: {
		...
		abilities: { 0: "Swift Swim", 1: "Shell Armor", H: "Weak Armor", S: "Anger Shell" },
		heightm: 1,
		weightkg: 35,
		color: "Blue",
		prevo: "Omanyte",
	...
	meganium: {
		...
		abilities: { 0: "Overgrow", H: "Leaf Guard", S: "Regenerator" },
		heightm: 1.8,
		weightkg: 100.5,
		color: "Green",
		prevo: "Bayleef",
	...
	donphan: {
		...
		abilities: { 0: "Sturdy", H: "Sand Veil", "S": "Rough Skin" },
		heightm: 1.1,
		weightkg: 120,
		color: "Gray",
		prevo: "Phanpy",
	...
	linoone: {
		...
		abilities: { 0: "Pickup", 1: "Gluttony", H: "Quick Feet", S: 'Adaptability' },
		heightm: 0.5,
		weightkg: 32.5,
		color: "White",
		prevo: "Zigzagoon",
	...
	swellow: {
		...
		abilities: { 0: "Guts", H: "Scrappy", S: "Flare Boost" },
		heightm: 0.7,
		weightkg: 19.8,
		color: "Blue",
		prevo: "Taillow",
	...
	plusle: {
		...
		abilities: { 0: "Plus", H: "Lightning Rod", S: "Prankster" },
		heightm: 0.4,
		weightkg: 4.2,
		color: "Yellow",
		eggGroups: ["Fairy"],
	...
	minun: {
		...
		abilities: { 0: "Minus", H: "Volt Absorb", S: "Prankster" },
		heightm: 0.4,
		weightkg: 4.2,
		color: "Yellow",
		eggGroups: ["Fairy"],
	...
	cacturne: {
		...
		abilities: { 0: "Sand Veil", H: "Water Absorb", S: "Stakeout" },
		heightm: 1.3,
		weightkg: 77.4,
		color: "Green",
		prevo: "Cacnea",
	...
	zangoose: {
		...
		abilities: { 0: "Immunity", S: "Toxic Boost" },
		heightm: 1.3,
		weightkg: 40.3,
		color: "White",
		eggGroups: ["Field"],
	...
	seviper: {
		...
		abilities: { 0: "Shed Skin", H: "Infiltrator", S: "Merciless" },
		heightm: 2.7,
		weightkg: 52.5,
		color: "Black",
		eggGroups: ["Field", "Dragon"],
	...
	infernape: {
		...
		abilities: { 0: "Blaze", H: "Iron Fist", S: "Scrappy" },
		heightm: 1.2,
		weightkg: 55,
		color: "Brown",
		prevo: "Monferno",
	...
	infernapemega: {
		...
		forme: "Mega",
		types: ["Fire", "Fighting"],
		baseStats: { hp: 76, atk: 134, def: 76, spa: 134, spd: 76, spe: 138 },
		abilities: { 0: "Godly Power" },
		heightm: 1.2,
		weightkg: 55,
		color: "Brown",
		eggGroups: ["Field", "Human-Like"],
	...
	pachirisu: {
		...
		abilities: { 0: "Run Away", 1: "Pickup", H: "Volt Absorb", S: "Electric Surge" },
		heightm: 0.4,
		weightkg: 3.9,
		color: "White",
		eggGroups: ["Field", "Fairy"],
	...
	mismagius: {
		...
		abilities: { 0: "Levitate", S: "Flare Boost" },
		heightm: 0.9,
		weightkg: 4.4,
		color: "Purple",
		prevo: "Misdreavus",
	...
	drapion: {
		...
		abilities: { 0: "Battle Armor", 1: "Sniper", H: "Keen Eye", S: "Intimidate" },
		heightm: 1.3,
		weightkg: 61.5,
		color: "Purple",
		prevo: "Skorupi",
	...
	carnivine: {
		...
		abilities: { 0: "Levitate", S: "Strong Jaw" },
		heightm: 1.4,
		weightkg: 27,
		color: "Green",
		eggGroups: ["Grass"],
	...
	rotom: {
		...
		color: "Red",
		eggGroups: ["Amorphous"],
		otherFormes: ["Rotom-Heat", "Rotom-Wash", "Rotom-Frost", "Rotom-Fan", "Rotom-Mow", "Rotom-Drone"],
		formeOrder: ["Rotom", "Rotom-Heat", "Rotom-Wash", "Rotom-Frost", "Rotom-Fan", "Rotom-Mow", "Rotom-Drone"],
	},
	rotomheat: {
		num: 479,
		name: "Rotom-Heat",
	...
	rotomfan: {
		...
		gender: "N",
		baseStats: { hp: 50, atk: 65, def: 107, spa: 105, spd: 107, spe: 86 },
		abilities: { 0: "Levitate", S: "Motor Drive" },
		heightm: 0.3,
		weightkg: 0.3,
		color: "Red",
		eggGroups: ["Amorphous"],
	...
	pignite: {
		...
		abilities: { 0: "Blaze", H: "Thick Fat", S: "Rock Head" },
		heightm: 1,
		weightkg: 55.5,
		color: "Red",
		prevo: "Tepig",
	...
	emboar: {
		...
		abilities: { 0: "Blaze", H: "Reckless", S: "Rock Head" },
		heightm: 1.6,
		weightkg: 150,
		color: "Red",
		prevo: "Pignite",
	...
	pansage: {
		...
		abilities: { 0: "Gluttony", H: "Overgrow", S: "Adaptability" },
		heightm: 0.6,
		weightkg: 10.5,
		color: "Green",
		evos: ["Simisage"],
	...
	pansear: {
		...
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 50, atk: 53, def: 48, spa: 53, spd: 48, spe: 64 },
		abilities: { 0: "Gluttony", H: "Blaze", S: "Adaptability" },
		heightm: 0.6,
		weightkg: 11,
		color: "Red",
		evos: ["Simisear"],
	...
	panpour: {
		...
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 50, atk: 53, def: 48, spa: 53, spd: 48, spe: 64 },
		abilities: { 0: "Gluttony", H: "Torrent", S: 'Adaptability' },
		heightm: 0.6,
		weightkg: 13.5,
		color: "Blue",
		evos: ["Simipour"],
	...
	crustle: {
		...
		abilities: { 0: "Sturdy", 1: "Shell Armor", H: "Weak Armor", S: "Anger Shell" },
		heightm: 1.4,
		weightkg: 200,
		color: "Red",
		prevo: "Dwebble",
	...
	scraggy: {
		...
		abilities: { 0: "Shed Skin", 1: "Moxie", H: "Intimidate", S: "Stamina" },
		heightm: 0.6,
		weightkg: 11.8,
		color: "Yellow",
		evos: ["Scrafty"],
	...
	yamask: {
		...
		abilities: { 0: "Mummy", S: "Magic Guard" },
		heightm: 0.5,
		weightkg: 1.5,
		color: "Black",
		evos: ["Cofagrigus"],
	...
	cofagrigus: {
		...
		abilities: { 0: "Mummy", S: "Magic Bounce" },
		heightm: 1.7,
		weightkg: 76.5,
		color: "Yellow",
		prevo: "Yamask",
	...
	carracosta: {
		...
		abilities: { 0: "Solid Rock", 1: "Sturdy", H: "Swift Swim", S: "Sap Sipper" },
		heightm: 1.2,
		weightkg: 81,
		color: "Blue",
		prevo: "Tirtouga",
	...
	archeops: {
		...
		abilities: { 0: "Defeatist", S: "Unnerve" },
		heightm: 1.4,
		weightkg: 32,
		color: "Yellow",
		prevo: "Archen",
	...
	jellicent: {
		...
		abilities: { 0: "Water Absorb", 1: "Cursed Body", H: "Damp", S: "Effect Spore" },
		heightm: 2.2,
		weightkg: 135,
		color: "White",
		prevo: "Frillish",
	...
	quilladin: {
		...
		abilities: { 0: "Overgrow", 1: "Rough Skin", H: "Bulletproof", S: "Stamina" },
		heightm: 0.7,
		weightkg: 29,
		color: "Green",
		prevo: "Chespin",
	...
	flabebe: {
		...
		abilities: { 0: "Flower Veil", H: "Symbiosis", S: "Shield Dust" },
		heightm: 0.1,
		weightkg: 0.1,
		color: "White",
		evos: ["Floette"],
	...
	floetteeternal: {
		...
		abilities: { 0: "Flower Veil", S: "Shield Dust" },
		heightm: 0.2,
		weightkg: 0.9,
		color: "White",
		eggGroups: ["Undiscovered"],
	...
	pangoro: {
		...
		abilities: { 0: "Iron Fist", 1: "Mold Breaker", H: "Scrappy", S: "Technician" },
		heightm: 2.1,
		weightkg: 136,
		color: "White",
		prevo: "Pancham",
	...
	aurorus: {
		...
		abilities: { 0: "Refrigerate", S: "Snow Warning" },
		heightm: 2.7,
		weightkg: 225,
		color: "Blue",
		prevo: "Amaura",
	...
	lycanroc: {
		...
		abilities: { 0: "Keen Eye", 1: "Sand Rush", H: "Steadfast", S: "Moxie" },
		heightm: 0.8,
		weightkg: 25,
		color: "Brown",
		prevo: "Rockruff",
	...
	lycanrocmidnight: {
		...
		abilities: { 0: "Keen Eye", 1: "Vital Spirit", H: "No Guard", S: "Rocky Payload" },
		heightm: 1.1,
		weightkg: 25,
		color: "Red",
		prevo: "Rockruff",
	...
	mrrime: {
		...
		abilities: { 0: "Tangled Feet", 1: "Screen Cleaner", H: "Ice Body", S: "Prankster" },
		heightm: 1.5,
		weightkg: 58.2,
		color: "Purple",
		prevo: "Mr. Mime-Galar",
	...
	dracozolt: {
		...
		abilities: { 0: "Volt Absorb", 1: "Hustle", S: "Sand Rush" },
		heightm: 1.8,
		weightkg: 190,
		color: "Green",
		eggGroups: ["Undiscovered"],
	...
	arctozolt: {
		...
		abilities: { 0: "Volt Absorb", 1: "Static", S: "Slush Rush" },
		heightm: 2.3,
		weightkg: 150,
		color: "Blue",
		eggGroups: ["Undiscovered"],
	...
	dracovish: {
		...
		abilities: { 0: "Water Absorb", 1: "Strong Jaw", S: "Sand Rush" },
		heightm: 2.3,
		weightkg: 215,
		color: "Green",
		eggGroups: ["Undiscovered"],
	...
	arctovish: {
		...
		abilities: { 0: "Water Absorb", 1: "Ice Body", S: "Slush Rush" },
		heightm: 2,
		weightkg: 175,
		color: "Blue",
		eggGroups: ["Undiscovered"],
	...
	dolliv: {
		...
		abilities: { 0: "Early Bird", H: "Harvest", S: "Grassy Surge" },
		heightm: 0.6,
		weightkg: 11.9,
		color: "Green",
		prevo: "Smoliv",
	...
	arboliva: {
		...
		abilities: { 0: "Seed Sower", H: "Harvest", S: "Grassy Surge" },
		heightm: 1.4,
		weightkg: 48.2,
		color: "Green",
		prevo: "Dolliv",
	...
	bombirdier: {
		...
		abilities: { 0: "Big Pecks", 1: "Keen Eye", H: "Rocky Payload", S: "Mountaineer" },
		heightm: 1.5,
		weightkg: 42.9,
		color: "White",
		eggGroups: ["Flying"],
	...
	houndstone: {
		...
		abilities: { 0: "Sand Rush", S: "Fluffy" },
		heightm: 2,
		weightkg: 15,
		color: "White",
		prevo: "Greavard",
